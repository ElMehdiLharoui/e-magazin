                                    ...
                                    { ?>
                                        <form action="contact.php" method="POST">
                                            <?php 
                                                ...
                                                if(isset($_POST['send']))
                                                {
                                                    $message_detail = trim($_POST['message']);
                                           ...
                                           ?>
                                            <div class="form-row">
                                                <div class="form-group col-md-6"><label class="text-dark" for="inputName">Full name</label>
                                        ...
                                        <table class="table table-bordered table-hover table-orange-soft mt-5" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th class="table-orange-soft" style="color: #708100 ;">Messages</th>
                                                    <th class="table-orange-soft" style="color: #708100;">Answers</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                        ...
                                                        $sql = "SELECT * FROM messages WHERE ms_username = :username ";
                                                        $stmt = $pdo->prepare($sql);
                                                        ...
                                                        { 
                                                            ...
                                                            $ms_reply = $messages['reply'];
                                                            ?>

                                                            <tr>
                                                                <td style="color: #778899; font-weight: bolder;"><?php echo $ms_detail; ?></td>
                                                                <td style="color: #778899; font-weight: bolder;"><?php echo $ms_reply; ?></td>
                                                            </tr>
