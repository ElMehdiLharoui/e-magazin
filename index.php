...
<?php require_once("./includes/header.php"); ?>
            ...
            <div id="layoutDefault_content">
                <main>
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-xl-8 col-lg-10 text-center">
                                        ...
                                        <h1 class="page-header-title">Welcome to Emagazine</h1>
                    ...
                    <section class="bg-white py-10">
                        ...
                        <hr />
                        <?php 
                            $sql4 = "SELECT * FROM products ORDER BY product_views DESC LIMIT 0, 1";
                        ...
                        ?>
                            ...
                            <div class="row">
                                <?php
                                    $sql = "SELECT * FROM products ORDER BY product_id DESC LIMIT $page_id,$product_per_page";   
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute();
                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-6 col-xl-4 mb-5">
                                                <a class="card post-preview lift h-100" href="single.php?post_id=<?php echo $product_id; ?>"
                                                    ><img class="card-img-top" src="./img/<?php echo $product_image; ?>" alt="<?php echo $product_image; ?>" style="margin-left: auto" />
                                                    <div class="card-body">
                                                        <h5 class="card-title"><?php echo $product_title; ?></h5>
     ...
     <?php                            
        ...
        ?>
                                                ...
                                                <?php
                                                    ...
                                                    if($previous+1 > 1 )
                                                    {
                                                        ...
                                                        echo '<li class="page-item">
                                                                <a class="page-link" href="index.php?page='. $previous .'"aria-label="Previous"><span aria-hidden="true">&#xAB;</span>
                                                                </a>
                                                            </li>';    
                                                    }
                                                    else
                            ...
                            <div class="row">
                                <?php 
                                    $sql2 = "SELECT * FROM products ORDER BY product_views DESC LIMIT 0, 3";
             ...
             <?php                            
                ...
                ?>
                                                        ...
                                                        <div class="post-preview-meta" style="color: black; font-family: cursive; font-size: 15px; font-weight: bold">
                                                            <?php echo $product_views; ?>
                                                            <i class="far fa-eye"></i>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row features text-center mb-5">
                                <?php 
                                    ...
                                    while($categories = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        $total_products = $categories['category_total_products'];
                                        if($total_products > 0) {
                                        ?>
                                        <div class="col-lg-4 col-md-6 mb-5">
                                            <a class="card card-link border-top border-top-lg border-primary h-100 lift" href="categories.php?category_id=<?php echo $category_id; ?>&category_name=<?php echo $category_title; ?>"
                                                ...
                                                <div class="card-footer bg-transparent pt-0 pb-5"><div class="badge badge-pill badge-light font-weight-normal px-3 py-2"><?php echo $total_products; ?> Products</div></div></a
                                            >
                                        </div>
                                    <?php }}
                                ?>
                            ...
                            {     
                                ...
                                { ?>
                                    <div class="col-12 text-center small">
                                        <a href="../DevZiko/backend/index.php"><strong style="color: red">Visit backend</strong></a>
                                    </div>
