            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <?php
                        ...
                        {
                            $url = "http://localhost/DevZiko/category-search.php?key=".$_POST['search-keyword']."&cat_id=".$_POST['category-id'];
                            header("Location: {$url}"); 
                        }
                    ...
                    <?php
                        if(isset($_GET['key'])) {
                            $keyword = $_GET['key'];
                            $cat_id = $_GET['cat_id'];
                            $sql = "SELECT * FROM products WHERE product_title LIKE :title AND product_category_id = :id";
                    ...
                    <section class="bg-white py-10">
                        <div class="container">
                            ...
                            <div class="row">
                                <?php 
                                    $sql = "SELECT * FROM products WHERE product_title LIKE :title AND product_category_id = :id LIMIT $page_id,$product_per_page";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([
                                                ...
                                                <?php
                                                    ...
                                                    if($previous+1 > 1 )
                                                    {
                                                        ...
                                                        echo '<li class="page-item">
                                                                <a class="page-link" href="category-search.php?key='. $_GET['key'].'&cat_id='. $_GET['cat_id'] .'&page='. $previous .'"aria-label="Previous"><span aria-hidden="true">&#xAB;</span>
                                                                </a>
                                                            </li>';    
                                                    }
                                                    else
