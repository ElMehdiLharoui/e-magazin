                    ...
                    <div class="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary">
                     ...
                     <?php 
                        ...
                        if(isset($_POST['edit']))
                        {
                            ...
                            $url = "http://localhost/DevZiko/backend/edit-category.php?id=".$id;
                            header("Location: {$url}");
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['update-category']))
                                    {
                                        ...
                                        $cat_status = $_POST['category-status'];
                                ...
                                <form action="edit-category.php?id=<?php echo $_GET['id']; ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category-status" class="form-control" id="cat-status">
                                            ...
                                            <option value="In Progress"<?php echo $category_status=='In Progress'?'selected':'' ?> >In Progress </option>
                                        </select>
                                    </div>
