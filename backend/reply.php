       ...
       <?php require_once("./includes/top-navbar.php"); ?>
        ...
        <div id="layoutSidenav">
            ...
            <?php 
                ...
                {
                    $ms_id = $_POST['ms-id'];
                    $url = "http://localhost/DevZiko/backend/reply.php?ms_id=".$ms_id;
                    header("Location: {$url}");
                }
            ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <?php
                            ...
                            {
                                $ms_reply = trim($_POST['reply']);
                                $sql = "UPDATE messages SET reply = :reply, ms_status = :status, ms_state = :state WHERE ms_id = :id";
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([':id' => $_GET['ms_id']]);
                                    $message = $stmt->fetch(PDO::FETCH_ASSOC);

                                    $ms_detail = $message['ms_detail'];
                                    $ms_username = $message['ms_username'];
                                 ?>
                                 <?php 
                                ...
                                <form action="reply.php?ms_id=<?php echo $_GET['ms_id']; ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="user-name" class="form-control" id="user-name" type="text" placeholder="User name ..." readonly="true" value="<?php echo $ms_username; ?>" />
                                    </div>                               
