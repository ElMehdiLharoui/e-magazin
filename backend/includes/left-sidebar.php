            ...
            <div class="nav accordion" id="accordionSidenav">
                    ...
                    { ?>
                        ...
                        <div class="collapse show" id="collapseLayouts" data-parent="#accordionSidenav">
                            <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavLayout">
                                <a class="nav-link" href="all-post.php">All Products</a>
                                <a class="nav-link" href="add-new.php">Add New Product</a>
                            </nav>
                        </div>
                ...
                ?>
                 ...
                 <?php
                    ...
                    if($curr_page == 'pages.php' || $curr_page == 'edit-order.php')
                    { ?>
                        <a class="nav-link active" href="pages.php" ><div class="nav-link-icon"><i data-feather="book-open"></i></div>
                            Orders
                        </a>
                    <?php } else 
                    { ?>
