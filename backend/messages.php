                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                while($messages = $stmt->fetch(PDO::FETCH_ASSOC))
                                                {
                                                    ...
                                                    $ms_detail = substr($messages['ms_detail'],0,30);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="badge badge-<?php echo $ms_status=="Processed"?"success":"warning"; ?>">
                                                                <?php echo $ms_status; ?>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <?php
                                                                ...
                                                                { ?>
                                                                    <form action="reply.php" method="POST">
                                                                        <input type="hidden" name="ms-id" value="<?php echo $ms_id; ?>">
                                                                        <button name="response" type="submit" class="btn btn-success btn-icon"><i data-feather="mail"></i></button>
                                                                    </form>
                                                                    
                                                                <?php } else { ?>
                                                                    <button title="Already resonded!" class="btn btn-success btn-icon"><i data-feather="check"></i></button>
                                                                <?php }
                                                             ?>
