        ...
        <div id="layoutSidenav">
            ...
            <?php 
                if(isset($_POST['edit-user'])) {
                    ...
                    $url = "http://localhost/DevZiko/backend/user-update.php?user_id=".$user_id;
                    header("Location: {$url}");
                }
            ...
            <div id="layoutSidenav_content">
                <main>
                            ...
                            // check if nickname exist :
                              ...
                              if(!isset($err_email) || !isset($err_nickname))
                              {
                                ...
                                if(empty($user_photo))
                                {
                                    ...
                                    $stmt2->execute([':id' => $_GET['user_id']] );
                                    $user = $stmt2->fetch(PDO::FETCH_ASSOC);
                                    $user_photo = $user['user_photo'];
                                }

                                $sql3 = "UPDATE users SET user_name = :name, user_nickname = :nickname, user_email = :email, user_role =:role, user_photo =:photo WHERE user_id = :id ";
                    ...
                    <!-- gettin data from the table users for showing its in the inputs  -->
